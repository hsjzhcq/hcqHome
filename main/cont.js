(() => {
    ...
    setTimeOut(async () => {
        ...
        if (res == null || res.code == -1) {
            ...
            Console(`[${name}] 用户您好， 欢迎━( * ｀∀´ * ) ノ亻!使用本脚本，该脚本为2.0版本 `);
    ...
    function getHtml() {
        ...
        <div id="hcq-main">
            ...
            <div class="coures-item" style="background-color: #666;color: #fff;overflow-y: auto;" id="supportBox">
                <br> <br>
                <center style="padding: 0 24px;">脚本制作不易,如果该脚本对你有帮助的话，希望客官能为该项目点一个免费的<a id="goToGithub" href="https://github.com/hsjzhcq/hcqHome">start</a>,作者在此感激不尽😘</center>
                <br> <br>
